/**
 * Flat-config equivalent of `.eslintrc.js`, for projects on ESLint 9+ /
 * `@wordpress/scripts` 32+ (which ignore the legacy `.eslintrc.js`).
 *
 * Both files are generated by `bin/update-configs`. Keep them in sync: any
 * rule change here should be mirrored in `.eslintrc.js` for as long as both
 * are generated.
 */
...
module.exports = [
...

	{
		...
		rules: {
			 ...
			 */
			'@wordpress/i18n-text-domain': [ 'error', { allowedTextDomain: [ 'wporg-photos' ] } ],
