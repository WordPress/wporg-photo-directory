...
/**
 * Title: No results
 * Slug: wporg-photos-2024/no-results
 * Inserter: no
 */
...
<div class="wp-block-group">
	...
	<p class="has-text-align-center has-eb-garamond-font-family has-heading-3-font-size" style="line-height:1.28"><?php esc_attr_e( 'No results found', 'wporg-photos' ); ?></p>
	<!-- /wp:paragraph -->
